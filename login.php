...
if(usern != null){
//document.getElementById("loginmorito").innerHTML = 'Your username and password is '+ usern + ' same with the plate number you provided. You may change it if you wish to.';

window.location.href = "changenewpass";
}
</script>
