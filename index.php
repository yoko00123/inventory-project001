...
<h2 style="color:green;">Inventory System</h2>
</div> 
<h4 style="color:dodgerblue; font-size:16px; margin:10px; text-align:center;" id="success"></h4>
    <div class="container">
      ...
      <center><button type="submit" name="submitLogin" style="font-size:16px; width:80%;">Login</button>
   </center>
    
      <span class="psw" style="color:blue;">Forgot <a href="#" style="color:blue;">password?</a></span>
...
if(usern != null){
document.getElementById("success").innerHTML = 'Success! You may now login your account.';
}
</script>
